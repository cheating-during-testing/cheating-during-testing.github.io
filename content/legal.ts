...
if (integrations.socialBar.provider === "adsterra-social-bar") {
  privacyIntegrationParagraphs.push(
    "Adsterra Social Bar advertising is enabled. Adsterra may process technical request information and applies its own privacy policy.",
  );
}
...
export const legalPages: SeoPageDefinition[] = [
  ...
  },
  {
    ...
    priority: "P2",
    navVisible: false,
    hero: { heading: "Contact", lead: "Report factual corrections, source concerns or technical site issues through our public GitHub repository." },
    sections: [
      {
        id: "contact-method",
        heading: "How to Reach Us",
        paragraphs: siteConfig.contact.email || siteConfig.contact.url
          ? ["Report factual corrections or site issues through the public GitHub Issues link. Include the affected page URL, the detail that needs correction and a reliable supporting source when possible."]
