    ...
    <>
      ...
      <main>
        <section className="hero-surface border-b border-border">
          <div className="site-container grid items-center gap-12 py-16 sm:py-24 lg:grid-cols-[1.15fr_.85fr]">
            ...
            <aside className="content-card p-4 sm:p-5" aria-label="Game summary">
              ...
              <img src={assetPath(siteConfig.assets.cover)} alt="Cheating During Testing Roblox classroom test gameplay banner" className="aspect-video w-full rounded-[calc(var(--radius)*.75)] object-cover" width="768" height="429" />
        ...
        <div className="site-container space-y-20 py-14 sm:py-20">
          <PageSections sections={homePage.sections} afterFirstSection={<NativeAdSlot />} />
